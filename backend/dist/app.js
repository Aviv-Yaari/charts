...
const point_routes_1 = __importDefault(require("./api/point/point.routes"));
...
mongoose_1.default
    .connect(dbUrl)
    .then(() => logger_service_1.logger.info('Mongodb connected'))
    .catch(logger_service_1.logger.error);
//#region Routes:
app.use('/api/auth', auth_routes_1.default);
app.use('/api/point', point_routes_1.default);
app.get('/**', (req, res) => {
...
const errorHandler = (err, req, res, next) => {
    ...
    const { customMessage = 'Unknown error' } = err;
    logger_service_1.logger.error(req.method + ' ' + req.path + ' ' + customMessage);
